    ...
    <section id="relume" className="px-[5%] py-16 md:py-24 lg:py-28">
      <div className="container flex flex-col items-center">
        <div className="rb-12 mb-12 max-w-lg text-center md:mb-18 lg:mb-20">
          <h1 className="mb-5 text-6xl font-bold md:mb-6 md:text-9xl lg:text-9xl sx:text-3xl">{heading}</h1>
          <p className="md:text-md sx:w-[330px] lg:w-full" >{description}</p>
...
export const Header78Defaults: Header78Props = {
  ...
  description:
    "A educação espacial utiliza o universo como uma ferramenta de aprendizado, estimulando a curiosidade e a imaginação dos alunos. Ao explorar conceitos astronômicos, os estudantes desenvolvem habilidades críticas e criativas que se aplicam em diversas áreas do conhecimento.",
   images: [
    {
